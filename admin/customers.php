                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row['blocked'] == 1) {
                                    echo "<a href='customers.php?action=unblock&id=" . $row["USER_ID"] . "'><button>Unblock</button></a>";
                                } else {
                                    echo "<a href='customers.php?action=block&id=" . $row["USER_ID"] . "'><button>Block</button></a>";
                                }
